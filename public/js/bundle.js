...
const login = async (email, password) => {
  try {
    ...
    var _err$response;
    (0, _alerts.showAlert)('error', ((_err$response = err.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || err.message);
  }
};
exports.login = login;
const logout = async () => {
...
},{"./login":"login.js","./mapBox":"mapBox.js","./updateSetting":"updateSetting.js","./stripe":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
